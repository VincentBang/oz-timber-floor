# Oz Timber Floor Launch Checklist ## Completed In Static Rebuild
...
- Domain deployment path is documented at /migration/domain-deployment-path.md and production deployment is on hold. ## Production Gate Audit - 2026-05-14
...
- Contact fallback: pass with visible phone and email actions rendered from /assets/contact-config.js. ## Manual Checks Still Required
