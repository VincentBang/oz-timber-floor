# Oz Timber Floor Final Crawl Report Generated: 2026-05-14 ## Redirect Integrity
...
- Remapped broad legacy range URLs away from /products/: /aspire-hybrid/, /luxury-hybrid/, /ornato-hybrid/ and /-classic/ now resolve to relevant range pages.
- /sitemap/ now maps to /sitemap.xml.
- Remaining generic catalogue redirects: /shop/ and /product-category/uncategorized/ still point to /products/ because the live URLs do not identify a specific range. ## Content Quality
...
- Each rewritten guide links to a relevant service page, product/category path and contact enquiry path. ## Contact And Launch Plumbing
...
- Standalone Oz Netlify config added at /netlify.toml inside the Oz site folder. ## Crawl Validation
...
- Contact form files found: contact.html and contact/index.html. ## Staging Submission Test
