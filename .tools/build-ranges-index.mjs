  ...
  : [
    {
      ...
      colourCount: '',
      url: '/-flooring-sydney/',
      primaryImage: '/assets/images/categories/-flooring-thumbnail.webp',
      description: 'A  flooring pathway kept visible while exact range and colour data is confirmed from source.'
    }
  ]
};
