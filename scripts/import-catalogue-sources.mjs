...
const IMPORT_GROUPS = [
  {
    ...
    rangeOverrides: {
      "laminate-12mm-24hr-water-resistant": { slug: "-etf-12mm-water-resistant-laminate", shortLabel: "ETF 12mm Laminate", family: " Laminate" },
      "hybrid-etf-7mm": { slug: "-etf-7mm-waterproof-hybrid", shortLabel: "ETF 7.0mm Hybrid", family: " SPC Hybrid" },
      "hybrid-etf-8mm": { slug: "-etf-8mm-waterproof-hybrid", shortLabel: "ETF 8.0mm Hybrid", family: " SPC Hybrid" },
      "hybrid-etf-9mm": { slug: "-etf-9mm-waterproof-hybrid", shortLabel: "ETF 9.0mm Hybrid", family: " SPC Hybrid" }
    },
    supplementalRanges: [
      ["-aquatuff-flooring", "AquaTuff Flooring", "hybrid", " lists AquaTuff as a separate waterproof flooring collection for busy homes and family traffic."],
      ["-6-5mm-hybrid", "ETF 6.5mm Hybrid", "hybrid", " lists a dedicated 6.5mm hybrid range alongside its thicker SPC hybrid collections."],
      ["-9-5mm-hybrid", "ETF 9.5mm Hybrid", "hybrid", " lists a 9.5mm hybrid collection for projects comparing thicker board constructions."],
      ["-10mm-hybrid", "ETF 10mm Hybrid", "hybrid", " lists a 10mm hybrid collection for projects wanting a heavier board feel."],
      ["-hybrid-herringbone", " Hybrid Herringbone", "hybrid", " lists a hybrid herringbone pathway separate from its straight plank SPC ranges."],
      ["-1-5m-laminate", " 1.5m Laminate", "laminate", " lists a 1.5 metre laminate category alongside its 1.2 metre laminate offering."],
      ["-72hr-water-resistant-laminate", " 72hr Water Resistant Laminate", "laminate", " lists a 72-hour water resistant laminate category as a separate laminate pathway."],
      ["-14mm-oak-flooring", " 14mm Oak Flooring", "engineered", " lists a 14mm oak engineered flooring category under its engineered range."],
      ["-15mm-oak-flooring", " 15mm Oak Flooring", "engineered", " lists a 15mm oak engineered flooring category for wider engineered options."],
      ["-oak-herringbone", " Oak Herringbone", "engineered", " lists an engineered oak herringbone category for patterned layouts."],
      ["-oak-chevron", " Oak Chevron", "engineered", " lists an engineered oak chevron category for premium pattern-led projects."],
      ["-australian-engineered", " Australian Engineered", "engineered", " lists an Australian engineered timber category alongside its oak collections."],
      ["-solid-timber", " Solid Timber", "solid", " also lists solid timber as a separate product family."]
    ]
  },
  {
    supplier: "",
    ...
    rangeIds: [
      "laminate-villeroy-boch-heritage",
      "laminate-villeroy-boch-country",
      "laminate-villeroy-boch-cosmopolitan",
      "laminate-villeroy-boch-contemporary",
      "laminate-swish-laminate-aqua",
      "laminate-swish-laminate",
      "hybrid-grande-9mm",
      "hybrid-xxl-8mm",
      "hybrid-grande-7-5mm",
      "hybrid-herringbone-7mm",
      "hybrid-urban-6-5mm",
      "hybrid-elite-6mm",
      "engineered-swish-oak-natura",
      "engineered-swish-oak-natura-herringbone",
      "engineered-swish-oak-wideboard",
      "engineered-swish-oak-contemporary",
      "engineered-swish-oak-natura-handcrafted"
    ],
    rangeOverrides: {
      "laminate-villeroy-boch-heritage": { slug: "villeroy-boch-heritage-laminate", shortLabel: "Villeroy & Boch Heritage", family: " Laminate" },
      "laminate-villeroy-boch-country": { slug: "villeroy-boch-country-laminate", shortLabel: "Villeroy & Boch Country", family: " Laminate" },
      "laminate-villeroy-boch-cosmopolitan": { slug: "villeroy-boch-cosmopolitan-laminate", shortLabel: "Villeroy & Boch Cosmopolitan", family: " Laminate" },
      "laminate-villeroy-boch-contemporary": { slug: "villeroy-boch-contemporary-laminate", shortLabel: "Villeroy & Boch Contemporary", family: " Laminate" },
      "laminate-swish-laminate-aqua": { slug: "swish-laminate-aqua", shortLabel: "Swish Laminate Aqua", family: " Laminate" },
      "laminate-swish-laminate": { slug: "swish-laminate-classic", shortLabel: "Swish Laminate", family: " Laminate" },
      "hybrid-grande-9mm": { slug: "grande-9mm-hybrid", shortLabel: "Grande 9.0 Hybrid", family: " Hybrid" },
      "hybrid-xxl-8mm": { slug: "xxl-8mm-hybrid", shortLabel: "XXL 8.0 Hybrid", family: " Hybrid" },
      "hybrid-grande-7-5mm": { slug: "grande-7-5mm-hybrid", shortLabel: "Grande 7.5 Hybrid", family: " Hybrid" },
      "hybrid-herringbone-7mm": { slug: "herringbone-7mm-hybrid", shortLabel: "Herringbone 7.0 Hybrid", family: " Hybrid" },
      "hybrid-urban-6-5mm": { slug: "urban-6-5mm-hybrid", shortLabel: "Urban 6.5 Hybrid", family: " Hybrid" },
      "hybrid-elite-6mm": { slug: "elite-6mm-hybrid", shortLabel: "Elite 6.0 Hybrid", family: " Hybrid" },
      "engineered-swish-oak-natura": { slug: "swish-oak-natura", shortLabel: "Swish Oak Natura", family: " Engineered" },
      "engineered-swish-oak-natura-herringbone": { slug: "swish-oak-natura-herringbone", shortLabel: "Swish Oak Natura Herringbone", family: " Engineered" },
      "engineered-swish-oak-wideboard": { slug: "swish-oak-wideboard", shortLabel: "Swish Oak Wideboard", family: " Engineered" },
      "engineered-swish-oak-contemporary": { slug: "swish-oak-contemporary", shortLabel: "Swish Oak Contemporary", family: " Engineered" },
      "engineered-swish-oak-natura-handcrafted": { slug: "swish-oak-natura-handcrafted", shortLabel: "Swish Oak Natura Handcrafted", family: " Engineered" }
    },
    supplementalRanges: []
  },
  {
    ...
    rangeOverrides: {
      "laminate-oak-step": { slug: "oak-step", shortLabel: "Oak Step", family: " Laminate" },
      "laminate-oak-step-plus": { slug: "oak-step-plus", shortLabel: "Oak Step PLUS", family: " Laminate" },
      "laminate-aqua-wood-plus-12mm": { slug: "aqua-wood-plus-12mm", shortLabel: "Aqua Wood Plus 12mm", family: " Laminate" },
      "hybrid-luxury-7mm": { slug: "luxury-hybrid-7mm", shortLabel: "Luxury Hybrid 7mm", family: " Hybrid" },
      "hybrid-luxury-8mm": { slug: "luxury-hybrid-8mm", shortLabel: "Luxury Hybrid 8mm", family: " Hybrid" },
      "hybrid-luxury-9mm": { slug: "luxury-hybrid-9mm", shortLabel: "Luxury Hybrid 9mm", family: " Hybrid" },
      "hybrid-luxury-plus-10mm": { slug: "luxury-hybrid-plus-10mm", shortLabel: "Luxury Hybrid PLUS 10mm", family: " Hybrid" },
      "engineered-botanica": { slug: "botanica-engineered", shortLabel: "Botanica", family: " Engineered" }
    },
    supplementalRanges: [
      ["coswick-hardwood", "Coswick Hardwood", "engineered", " promotes Coswick Hardwood as a separate engineered flooring pathway with European-made constructions and matching accessories."]
    ]
  }
];
...
function main() {
  ...
  appendImportSection(path.join(OZ_ROOT, "products.html"), "ADDITIONAL SUPPLIER IMPORT", ", Eco and Bass supplier ranges", "These supplier-backed range pages and product pages now sit inside the Oz catalogue with supply-only, stock and supply + install enquiry paths.", supplierCards);
  ...
  appendImportSection(path.join(OZ_ROOT, "hybrid-flooring-sydney.html"), "ADDITIONAL HYBRID SUPPLIER IMPORT", "Imported supplier hybrid collections", "Oz now includes supplier-backed hybrid collections from , ,  and .", hybridCards);
  ...
  appendImportSection(path.join(OZ_ROOT, "laminate-flooring-sydney.html"), "ADDITIONAL LAMINATE SUPPLIER IMPORT", "Imported supplier laminate collections", "Oz now includes supplier-backed laminate collections from , ,  and  pathways.", laminateCards);
  ...
  appendImportSection(path.join(OZ_ROOT, "engineered-timber-flooring-sydney.html"), "ADDITIONAL ENGINEERED SUPPLIER IMPORT", "Imported supplier engineered collections", "Oz now includes supplier-backed engineered timber collections from , ,  and .", engineeredCards);

  const note = `# Supplier import notes
\n- Added supplier-backed import pages for ,  and  on ${new Date().toISOString().slice(0, 10)}.\n- Product-level imports were created where the shared supplier dataset already contains item-level data.\n- Additional live-only range pages were created for  and Bass where the current live site shows a product family but the workspace does not yet hold a full SKU dataset.\n- Remaining manual gap: Bass Coswick Hardwood still needs full SKU extraction if Oz wants every Coswick colour/product split as separate product pages.\n`;
